 ...
 *
 * 法律抚养关系（custodianId）与「本月能否亲自照料」分离：
 *  - confined / cold_palace 表示**暂时**不能照料——绝不据此清除 custodianId；
 ...
 * （皇后死亡/入冷宫造成的死锁）——custodianId 死后不清除，故为 deceased/cold_palace，
