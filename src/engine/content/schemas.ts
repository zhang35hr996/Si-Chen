...
export const eventEffectSchema = z.union([
  ...
  z.strictObject({
    type: z.literal("send_to_cold_palace"),
    char: idSchema,
    statusEffectId: z.string(),
    punishmentId: z.string().regex(/^pun_\d{6}$/),
    coldPalaceResidenceId: idSchema,
    previousResidenceId: idSchema,
