...
export type PunishmentRecord =
  ...
  | (PunishmentBase & { targetKind: "consort"; kind: "cold_palace"; details: { statusEffectId: string; previousResidenceId: string; previousChamber?: string; coldPalaceResidenceId: string } })
