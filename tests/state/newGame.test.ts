...
describe("createNewGameState", () => {
  ...
  it("seeds standing for characters with an initial standing", () => {
    expect(state.standing["shen_zhibai"]).toMatchObject({ rank: "fenghou", favor: 25, affection: 50, palaceEnteredAt: { year: 1, month: 1, period: "early", dayIndex: 0 }, health: 78, healthStatus: "healthy" });
