...
describe("createInitialState", () => {
  ...
  it("initializes the resource pillars with placeholder values", () => {
    ...
    expect(resources.nation).toEqual({ military: 50, treasury: 10000, publicSupport: 50, productivity: 50, governance: 50, consortClanPower: 30, ministerLoyalty: 50, corruption: 20, clanDiscontent: 20, rumor: 10, borderPressure: 35 });
