...
function heirWithFavor(favor: number): GameState {
  ...
  s.resources.bloodline.heirs.push({
    ...
    favor, legitimate: true, petName: "团团", education: { scholarship: 5, martial: 5, virtue: 5 }, health: 60, talent: 50, diligence: 50, ambition: 20, closeness: 50, support: 20, faction: "none",
  });
  return s;
}
